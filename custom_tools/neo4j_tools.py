...
class CommunityRetrievalTools:
    """社区检索工具类，基于Neo4j单例连接实现"""
    ...
    def retrieve_community_then_subcommunities(
        ...
        if property_filter:
            ...
            main_communities = self.retrieve_communities_by_property(
        ...
        if len(main_communities) < community_limit:
            ...
            embedding_results = self.retrieve_communities_by_embedding(
                query=query,
        ...
        for community in main_communities:
            ...
            subcommunities = self.retrieve_subcommunities(
...
def get_neo4j_tools():
    ...
    community_tools = CommunityRetrievalTools(embeddings=embeddings)
    return [
        community_tools.retrieve_communities_by_property,
        community_tools.retrieve_communities_by_embedding,
        community_tools.retrieve_subcommunities,
        community_tools.retrieve_community_then_subcommunities,
    ]
